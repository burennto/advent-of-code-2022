...
class Day8Test < Minitest::Test
  def test_example
    assert_equal 21, solve_part_1('example.txt')
    assert_equal 8, solve_part_2('example.txt')
  end

  def test_answers
    assert_equal 1713, solve_part_1('input.txt')
    assert_equal 268464, solve_part_2('input.txt')
  end
end
